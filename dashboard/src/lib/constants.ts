export const SKILL_SAMPLES: Record<string, Record<string, unknown>> = {
  ...
  "qualifier": {
    ...
    tech_stack: ["Spark", "dbt", "Airflow", "Kubernetes"],
    signal_type: "job_posting",
    signal_detail: "Hiring 3 ML engineers",
    qualification_criteria: "Series B+ data infrastructure companies with 200+ employees, engineering leadership contacts",
  },
  "angle-selector": {
    first_name: "Emily",
    last_name: "Park",
...
export const SKILL_FIELDS: Record<string, SkillFieldMeta[]> = {
  ...
  "qualifier": [
    { name: "first_name", required: false, placeholder: "Marcus", type: "text" },
    { name: "last_name", required: false, placeholder: "Rivera", type: "text" },
    { name: "title", required: false, placeholder: "Head of Data", type: "text" },
    { name: "company_name", required: true, placeholder: "Snowflake", type: "text" },
    { name: "company_domain", required: false, placeholder: "snowflake.com", type: "text" },
    ...
    { name: "funding_stage", required: false, placeholder: "Series C", type: "text" },
    { name: "qualification_criteria", required: false, placeholder: "Series B+ data companies with 200+ employees", type: "textarea" },
    { name: "client_slug", required: false, placeholder: "twelve-labs", type: "text" },
  ],
  "angle-selector": [
